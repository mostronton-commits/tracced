...
def sort_rows(rows):
    """Найбільший реалізований PnL зверху — те число, що видно в колонці PnL; за рівного — більший нереалізований.

    Раніше рахувалась сума реалізованого і нереалізованого, і гаманець з нулем у колонці стояв першим: сторінка
    виглядала невідсортованою. У цьому ж порядку аналіз перевіряє вік і спонсора перших гаманців."""
