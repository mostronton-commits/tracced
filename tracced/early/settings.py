...
DEFAULTS = {
    ...
    "profile_days": 30,
    "profile_max_pages": 5,      # до 1000 обмінів на сторінку; активнішим гаманцям показуємо «partial»
    "wallet_profile_ttl_hours": 24,
    # хто стоїть за гаманцем (KOL, Twitter, платформа): Solana Tracker додає це до сторінок угод на прохання
    "st_identity": True,
