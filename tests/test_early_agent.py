...
class TestDigest(unittest.TestCase):
    def test_numbers_come_from_the_result_and_the_filter_from_the_method(self):
        ...
        self.assertEqual(d["wallets"]["net_realized_all_wallets"], "$3.8M")   # так, як пише людина
        ...
        self.assertEqual(d["watch_candidates"]["method"], "profit · 3x+ · held 10m+ · no bot-like, fresh")
        self.assertEqual(d["watch_candidates"]["wallets"][1]["held"], "47h")   # 2818 хв порахував код, не модель
...
class TestCheck(unittest.TestCase):
    ...
    def test_a_rounded_short_form_of_a_big_number_passes_a_small_number_must_match(self):
        keep, dropped = check_bullets(["Net realized $3.8M, or $3.797M.", "Best ROI 17x.", "Best ROI 25x."], self.d, self.wmap)
        self.assertEqual(keep, ["Net realized $3.8M, or $3.797M.", "Best ROI 17x."])   # 17x — округлені 16.82x
        self.assertIn("25", dropped[0]["why"])                                         # 25x — вигадане
