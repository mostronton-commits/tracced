...
Tick wallets in a result and press **+ Watchlist** to keep them. **Save analysis** keeps the whole result.

Both live at `/me`, both export to CSV and TXT, and both are two-way: click the star again to remove.

## Your own tags

Each saved wallet takes tags you write yourself. Type a short word, press Enter. Click a tag to remove it.
...
**Who ran an analysis is never shown.** Your watchlist, your own tags and your saved list are yours alone.
